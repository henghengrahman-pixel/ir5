...
router.post('/posts', requireAdmin, uploadImage.fields([{ name:'thumbnailFile', maxCount:1 }, { name:'coverFile', maxCount:1 }]), admin.postCreate);
router.get('/posts/:id/edit', requireAdmin, admin.postEditPage);
router.post('/posts/:id/update', requireAdmin, uploadImage.fields([{ name:'thumbnailFile', maxCount:1 }, { name:'coverFile', maxCount:1 }]), admin.postUpdate);
...
router.post('/settings', requireAdmin, uploadImage.fields([{ name:'logoFile', maxCount:1 }, { name:'faviconFile', maxCount:1 }, { name:'backgroundDesktopFile', maxCount:1 }, { name:'backgroundMobileFile', maxCount:1 }, { name:'ogImageFile', maxCount:1 }]), admin.settingsUpdate);
